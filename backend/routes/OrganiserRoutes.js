...
const {login,getProfile,updateProfile,changePassword,getAllOrganizers,getOrganizerById,getEventCsv,getAnalytics,requestPasswordReset} = require('../controllers/OrganiserController');
...
router.put('/change-password',authenticateUser,requireRole(['organizer']),changePassword);
